...
- [Sharpe MCP Server](https://www.sharpe.ai/docs/mcp-server) - Sharpe Terminal MCP for crypto derivatives and market intelligence across funding rates, futures, options, arbitrage, narratives, exchange listings, news, and token-risk checks; install with `uvx sharpe-mcp`.
