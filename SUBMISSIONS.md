...
| [demcp/awesome-web3-mcp-servers](https://github.com/demcp/awesome-web3-mcp-servers) | Web3-specific MCP list and one of the cleanest category-fit discovery surfaces for Hive. | Do not open a duplicate. Keep the active Hive PR warm and resolve maintainer feedback if review resumes. | PR open but review-blocked: https://github.com/demcp/awesome-web3-mcp-servers/pull/78. Older stale duplicate from 2025-09-10 remains open at https://github.com/demcp/awesome-web3-mcp-servers/pull/10; close was blocked by GitHub permissions, so a superseded comment was added on 2026-06-01 pointing maintainers to #78. |
