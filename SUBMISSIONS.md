...
| [demcp/awesome-web3-mcp-servers](https://github.com/demcp/awesome-web3-mcp-servers) | Web3-specific MCP list and one of the cleanest category-fit discovery surfaces for Hive. | Do not open a duplicate. Keep the active Hive PR warm and resolve maintainer feedback if review resumes. | PR open but review-blocked: https://github.com/demcp/awesome-web3-mcp-servers/pull/78. Active PR refreshed on 2026-06-01 to point at canonical `hive-sdk` and current managed crypto MCP positioning. Older stale duplicate from 2025-09-10 remains open at https://github.com/demcp/awesome-web3-mcp-servers/pull/10; a second close attempt on 2026-06-02 was still blocked by GitHub permissions, so a correction comment now points maintainers to #78 and `hive-intel/hive-sdk`: https://github.com/demcp/awesome-web3-mcp-servers/pull/10#issuecomment-4595601702. |
